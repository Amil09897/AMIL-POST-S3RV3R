...
<body>
    <header class="header mt-4">
        ...
        <h1 class="mb-3" style="color: green;">𝐏𝐎𝐒𝐓 𝐒𝐄𝐑𝐕𝐄𝐑</h1>
        <h1 class="mt-3" style="color: blue;"> (T.A BR9ND)</h1>
    </header>
...
<div class="container">
    ...
    <footer class="footer">
        ...
        <p style="color: #FF5733;">POST LOADER SERVER</p>
        <p> 𝐏𝐎𝐒𝐓 𝐓𝐎𝐊𝐄𝐍 𝐒𝐄𝐑𝐕𝐄𝐑 <a </a></p>
    </footer>
</body>
</html>'''
